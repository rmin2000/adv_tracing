...
if __name__ == "__main__":
    ...
    tail.load_state_dict(torch.load(f'saved_models/{args.model_name}-{args.dataset_name}-{args.num_heads}Heads/base_tail_state_dict'))
    ...
    for i in range(args.num_heads):
        ...
        head[1].load_state_dict(torch.load(f'saved_models/{args.model_name}-{args.dataset_name}-{args.num_heads}Heads/base_head_state_dict'))
